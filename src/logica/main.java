...
public class main {
    ...
    public static void main(String[] args) {
        ...
        //Creo el jLabel para modificar el usuario en menu principal        
        JLabel jLbarraNombre = new JLabel("Usuario: Desconectado");
        JLabel jLbarraAcesso = new JLabel("Acesso: ");

        //Menu inicio
        ControlAcceso control = new ControlAcceso(jLbarraNombre, jLbarraAcesso);
        //Creo 
        MenuPrincipal menuP = new MenuPrincipal(control);
        control.setMenuPrincipal(menuP);
        menuP.setVisible(true);
        menuP.setLocationRelativeTo(null); // con esto inicio centrada la ventana

        //Pruebas en MAIN de metodos CRUD   
