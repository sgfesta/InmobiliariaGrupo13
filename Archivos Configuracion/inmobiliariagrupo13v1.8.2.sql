...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2023 a las 16:55:24
...
INSERT INTO `contrato` (`idContrato`, `idPropiedad`, `idPropietario`, `idInquilino`, `idGarante`, `idUsuario`, `fechaInicio`, `fechaFin`, `fechaContrato`, `vigente`, `renovado`, `activo`) VALUES
(2, 1, 1, 1, 1, 1, '2023-03-05', '2026-03-05', '2023-03-02', 1, 0, 0);
...
(2, 1, 'Echevarria 540', 897, 1, 300, 250000, 3, 1, 1, 1, 'tiene luz y electricidad', 1, 1),
(3, 2, 'Calle 45', 892, 1, 500, 200700, 6, 1, 1, 3, 'No tiene Garaje. Tiene Agua ,Luz y cloacas. Apto para refeccionar.A cuadras del centro.', 1, 1),
...
--
ALTER TABLE `inspector`
  MODIFY `idInspector` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `propiedad`
--
ALTER TABLE `propiedad`
  MODIFY `idPropiedad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
